...
public class HediffComp_Venom : HediffComp
{
	...
	public override void CompPostPostAdd(DamageInfo? dinfo)
	{
		...
		float num = Mathf.Max(1f - parent.pawn.GetStatValue(StatDefOf.ToxicResistance), 0f);
		_venomPerTick = Props.VenomPerSeverity * parent.Severity / parent.pawn.BodySize * num;
