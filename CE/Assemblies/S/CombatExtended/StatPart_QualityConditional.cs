...
public class StatPart_QualityConditional : StatPart
{
	...
	{
		QualityConditionalModExt modExtension = req.Def.GetModExtension<QualityConditionalModExt>();
		if ((modExtension == null || modExtension.UseQualityMult) && (!(val <= 0f) || applyToNegativeValues))
		{
