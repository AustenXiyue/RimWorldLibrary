...
public class CompAdditionalGraphicSwitch : ThingComp
{
	...
	private Graphic Graphic => GraphicDatabase.Get(typeof(Graphic_Multi), graphicPath, ShaderTypeDefOf.Cutout.Shader, Props.drawSize, Color.white, Color.white);
	...
	public IEnumerable<Gizmo> GetGizmos()
	{
		...
		yield return new Command_Action
		{
			...
			icon = ContentFinder<Texture2D>.Get("AncotLibrary/Gizmos/SwitchA"),
			action = delegate
			{
