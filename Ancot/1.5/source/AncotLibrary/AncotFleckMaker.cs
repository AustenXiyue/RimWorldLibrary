...
{
	public static void CustomFleckThrow(Map map, FleckDef fleckDef, Vector3 loc, Color color, Vector3 offset, float scale = 1f, float rotationRate = 0f, float velocityAngle = 0f, float velocitySpeed = 0f)
	{
