...
public class Verb_Job : Verb
{
	...
	{
		return TryGiveJob(base.EquipmentSource.TryGetComp<CompApparelReloadable>(), currentTarget);
	}

	public bool TryGiveJob(CompApparelReloadable reloadable, LocalTargetInfo target)
	{
