...
public class CompAIShieldHolder_Incoming : ThingComp
{
	...
	{
		if (compPhysicalShield != null && compPhysicalShield.holdShield && PawnOwner != null && PawnOwner.Spawned && (PawnOwner.Faction != Faction.OfPlayer || (autoFightForPlayer && !PawnOwner.Drafted)) && shieldHoldingTickLeft > 0)
		{
			shieldHoldingTickLeft--;
