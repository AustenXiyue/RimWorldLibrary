...
public class Projectile_ExplosiveWithTrail : Projectile_Explosive
{
	...
	protected void DoExplosion(IntVec3 pos, Map map, float radius)
	{
		...
		GenExplosion.DoExplosion(pos, map, radius, damType, launcher, damAmount, armorPenetration, null, equipmentDef, def, intendedTarget.Thing, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
	}
}
