		...
		if (Props.angle != 0f)
		{
			if (num - 30f < -180f || num + 30f > 180f)
			{
				if (num < 0f)
				{
					...
					GenExplosion.DoExplosion(positionHeld, map, radius, damageDef, instigator, damageAmount, armorPenetration, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, affectedAngle);
					...
					GenExplosion.DoExplosion(positionHeld2, map2, radius2, damageDef2, instigator2, damageAmount2, armorPenetration2, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, affectedAngle);
				}
				else
				{
					...
					GenExplosion.DoExplosion(positionHeld3, map3, radius3, damageDef3, instigator3, damageAmount3, armorPenetration3, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, affectedAngle);
					...
					GenExplosion.DoExplosion(positionHeld4, map4, radius4, damageDef4, instigator4, damageAmount4, armorPenetration4, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, affectedAngle);
				}
			}
			else
			{
				...
				GenExplosion.DoExplosion(positionHeld5, map5, radius5, damageDef5, instigator5, damageAmount5, armorPenetration5, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, affectedAngle);
			}
		}
		else
		{
			GenExplosion.DoExplosion(parent.PositionHeld, parent.Map, Props.radius, Props.damageDef, parent, Props.damageAmount, Props.armorPenetration, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
		}
		parent.Kill(null);
	}
}
