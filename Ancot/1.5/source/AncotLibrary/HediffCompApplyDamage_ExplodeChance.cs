...
public class HediffCompApplyDamage_ExplodeChance : HediffComp
{
	...
	public override void Notify_PawnPostApplyDamage(DamageInfo dinfo, float totalDamageDealt)
	{
		...
		{
			GenExplosion.DoExplosion(base.Pawn.PositionHeld, base.Pawn.MapHeld, Props.explosionRadius, Props.damageDef, base.Pawn, Props.damageAmountBase, Props.armorPenetrationBase, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
