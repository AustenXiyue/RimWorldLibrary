...
public class Ability_ReverseEngineer : Ability
{
	...
	private static readonly FieldRef<ResearchManager, Dictionary<ResearchProjectDef, float>> progressRef = AccessTools.FieldRefAccess<ResearchManager, Dictionary<ResearchProjectDef, float>>("progress");
	...
	public override void Cast(params GlobalTargetInfo[] targets)
	{
			...
			select project)
		{
			...
			progressRef.Invoke(Find.ResearchManager)[item] = item.baseCost;
