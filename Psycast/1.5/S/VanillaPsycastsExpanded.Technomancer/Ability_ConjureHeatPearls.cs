...
{
	private static readonly FieldRef<Pawn_PsychicEntropyTracker, float> currentEntropy = AccessTools.FieldRefAccess<Pawn_PsychicEntropyTracker, float>("currentEntropy");
	...
	public override void Cast(params GlobalTargetInfo[] targets)
	{
		...
		currentEntropy.Invoke(base.pawn.psychicEntropy) -= 20f;
		...
		GenExplosion.DoExplosion(intVec, map, 1.9f, bomb, pawn, -1, -1f, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, ignoredThings, null);
