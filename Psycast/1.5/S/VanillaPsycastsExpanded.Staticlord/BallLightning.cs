...
public class BallLightning : AbilityProjectile
{
	...
	protected override void DrawAt(Vector3 drawLoc, bool flip = false)
	{
		...
		foreach (Thing currentTarget in currentTargets)
		{
			...
			Matrix4x4 matrix = Matrix4x4.TRS(vector + (vector2 - vector) / 2f + Vector3.up * (((Thing)this).def.Altitude - 1f / 52f), Quaternion.LookRotation(vector2 - vector), s);
