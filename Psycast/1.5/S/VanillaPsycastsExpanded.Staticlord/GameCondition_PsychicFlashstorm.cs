...
{
	private static readonly FieldRef<GameCondition_Flashstorm, int> nextLightningTicksRef = AccessTools.FieldRefAccess<GameCondition_Flashstorm, int>("nextLightningTicks");
	...
	public override void GameConditionTick()
	{
		...
		if (nextLightningTicksRef.Invoke((GameCondition_Flashstorm)this) - Find.TickManager.TicksGame > TicksBetweenStrikes)
		{
			nextLightningTicksRef.Invoke((GameCondition_Flashstorm)this) = TicksBetweenStrikes + Find.TickManager.TicksGame;
		}
		for (int i = 0; i < 2; i++)
		{
