...
public class Ability_NeuralHeatDetonation : Ability
{
	...
	public override void Cast(params GlobalTargetInfo[] targets)
	{
		...
		GenExplosion.DoExplosion(cell, map, radiusForPawn, flame, pawn, -1, -1f, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, ignoredThings, null);
	}
}
