...
public class Ability_AggressiveHeatDump : Ability
{
	...
	public override void Cast(params GlobalTargetInfo[] targets)
	{
		...
		GenExplosion.DoExplosion(cell, map, radiusForPawn, flame, pawn, damAmount, -1f, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, ignoredThings, null);
	}
}
