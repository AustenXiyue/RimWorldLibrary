	...
	public override void PostTick()
	{
		...
		else
		{
			...
			if (list2.Any())
			{
				...
				IEnumerable<Hediff_MissingPart> enumerable = source.Where((Hediff_MissingPart x) => !currentMissingHediffs2.Contains(x));
				foreach (Hediff_MissingPart item in enumerable)
				{
