...
{
	[DebugAction("Pawns", "Check Meditation Focus Strength", true, false, false, false, 0, false, actionType = DebugActionType.ToolMapForPawns, allowedGameStates = AllowedGameStates.PlayingOnMap)]
