...
public class Hediff_Overshield : Hediff_Overlay
{
	...
	public virtual bool CanDestroyProjectile(Projectile projectile)
	{
		...
		return Vector3.Distance(projectile.ExactPosition.Yto0(), ((Hediff)(object)this).pawn.DrawPos.Yto0()) <= OverlaySize && !GenRadial.RadialCellsAround(((Hediff)(object)this).pawn.Position, OverlaySize, useCenter: true).ToList().Contains(item);
	}
