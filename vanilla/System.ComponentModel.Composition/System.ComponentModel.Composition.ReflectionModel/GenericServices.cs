...
internal static class GenericServices
{
	...
	public static bool CanSpecialize(Type type, GenericParameterAttributes attributes)
	{
		...
		if ((attributes & GenericParameterAttributes.ReferenceTypeConstraint) != 0 && type.IsValueType)
		{
			return false;
		}
		if ((attributes & GenericParameterAttributes.DefaultConstructorConstraint) != 0 && !type.IsValueType && type.GetConstructor(Type.EmptyTypes) == null)
		{
			return false;
		}
