...
public class TMP_FontAsset : TMP_Asset
{
	...
	internal void AddSynthesizedCharactersAndFaceMetrics()
	{
		...
		AddSynthesizedCharacter(3u, addImmediately: true);
		AddSynthesizedCharacter(9u, addImmediately: true);
		AddSynthesizedCharacter(10u);
		AddSynthesizedCharacter(11u);
		AddSynthesizedCharacter(13u);
		AddSynthesizedCharacter(1564u);
		AddSynthesizedCharacter(8203u);
		AddSynthesizedCharacter(8206u);
		AddSynthesizedCharacter(8207u);
		AddSynthesizedCharacter(8232u);
		AddSynthesizedCharacter(8233u);
		AddSynthesizedCharacter(8288u);
	...
	private void AddSynthesizedCharacter(uint unicode, bool addImmediately = false)
	{
		...
		if (m_AtlasPopulationMode == AtlasPopulationMode.Dynamic && FontEngine.GetGlyphIndex(unicode) != 0)
		{
			if (addImmediately)
			{
