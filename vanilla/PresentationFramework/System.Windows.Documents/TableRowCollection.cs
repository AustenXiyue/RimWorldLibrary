...
public sealed class TableRowCollection : IList<TableRow>, ICollection<TableRow>, IEnumerable<TableRow>, IEnumerable, IList, ICollection
{
	...
	bool IList.IsFixedSize => ((IList)_rowCollectionInternal).IsFixedSize;
	...
	bool IList.IsReadOnly => ((IList)_rowCollectionInternal).IsReadOnly;
	...
	public int Count => _rowCollectionInternal.Count;

	/// <summary>This type or member supports the Windows Presentation Foundation (WPF) infrastructure and is not intended to be used directly from your code.</summary>
	/// <returns>Currently, this property always returns false.</returns>
	public bool IsReadOnly => ((IList)_rowCollectionInternal).IsReadOnly;

	/// <summary>This type or member supports the Windows Presentation Foundation (WPF) infrastructure and is not intended to be used directly from your code.</summary>
	/// <returns>Currently, this property always returns false.</returns>
	public bool IsSynchronized => ((ICollection)_rowCollectionInternal).IsSynchronized;

	/// <summary>This type or member supports the Windows Presentation Foundation (WPF) infrastructure and is not intended to be used directly from your code.</summary>
	/// <returns>An object that can be used to synchronize access to the collection.</returns>
	public object SyncRoot => ((ICollection)_rowCollectionInternal).SyncRoot;
