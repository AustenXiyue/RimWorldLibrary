...
internal class XamlContextStack<T> where T : MS.Internal.Xaml.Context.XamlFrame
{
	private int _depth;
	...
	public XamlContextStack(MS.Internal.Xaml.Context.XamlContextStack<T> source, bool copy)
	{
