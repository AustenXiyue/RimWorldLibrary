...
internal class BamlPropertyWithConverterRecord : BamlPropertyRecord
{
	...
	internal override BamlRecordType RecordType => BamlRecordType.PropertyWithConverter;
	...
	{
		base.Copy(record);
		((BamlPropertyWithConverterRecord)record)._converterTypeId = _converterTypeId;
	}
}
