...
{
	internal const string PresentationNative = "PresentationNative_cor3.dll";

	internal const string PresentationCFFRasterizerNative = "PresentationCFFRasterizerNative_cor3.dll";

	internal const string MilCore = "wpfgfx_cor3.dll";
