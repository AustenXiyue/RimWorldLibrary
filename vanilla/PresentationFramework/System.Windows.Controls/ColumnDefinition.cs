...
public class ColumnDefinition : DefinitionBase
{
	...
	public static readonly DependencyProperty WidthProperty = DependencyProperty.Register("Width", typeof(GridLength), typeof(ColumnDefinition), new FrameworkPropertyMetadata(new GridLength(1.0, GridUnitType.Star), DefinitionBase.OnUserSizePropertyChanged), DefinitionBase.IsUserSizePropertyValueValid);
	...
	public static readonly DependencyProperty MinWidthProperty = DependencyProperty.Register("MinWidth", typeof(double), typeof(ColumnDefinition), new FrameworkPropertyMetadata(0.0, DefinitionBase.OnUserMinSizePropertyChanged), DefinitionBase.IsUserMinSizePropertyValueValid);
	...
	[CommonDependencyProperty]
	[TypeConverter("System.Windows.LengthConverter, PresentationFramework, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35, Custom=null")]
	public static readonly DependencyProperty MaxWidthProperty = DependencyProperty.Register("MaxWidth", typeof(double), typeof(ColumnDefinition), new FrameworkPropertyMetadata(double.PositiveInfinity, DefinitionBase.OnUserMaxSizePropertyChanged), DefinitionBase.IsUserMaxSizePropertyValueValid);
