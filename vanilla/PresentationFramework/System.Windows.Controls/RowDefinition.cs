...
public class RowDefinition : DefinitionBase
{
	...
	public static readonly DependencyProperty HeightProperty = DependencyProperty.Register("Height", typeof(GridLength), typeof(RowDefinition), new FrameworkPropertyMetadata(new GridLength(1.0, GridUnitType.Star), DefinitionBase.OnUserSizePropertyChanged), DefinitionBase.IsUserSizePropertyValueValid);
	...
	public static readonly DependencyProperty MinHeightProperty = DependencyProperty.Register("MinHeight", typeof(double), typeof(RowDefinition), new FrameworkPropertyMetadata(0.0, DefinitionBase.OnUserMinSizePropertyChanged), DefinitionBase.IsUserMinSizePropertyValueValid);
	...
	[CommonDependencyProperty]
	[TypeConverter("System.Windows.LengthConverter, PresentationFramework, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35, Custom=null")]
	public static readonly DependencyProperty MaxHeightProperty = DependencyProperty.Register("MaxHeight", typeof(double), typeof(RowDefinition), new FrameworkPropertyMetadata(double.PositiveInfinity, DefinitionBase.OnUserMaxSizePropertyChanged), DefinitionBase.IsUserMaxSizePropertyValueValid);
