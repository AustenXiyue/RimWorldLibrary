...
public class ThicknessAnimation : ThicknessAnimationBase
{
	...
	protected override Thickness GetCurrentValueCore(Thickness defaultOriginValue, Thickness defaultDestinationValue, AnimationClock animationClock)
	{
		...
		case AnimationType.From:
			thickness = _keyValues[0];
			thickness2 = defaultDestinationValue;
			flag2 = true;
			break;
		case AnimationType.To:
			thickness = defaultOriginValue;
			thickness2 = _keyValues[0];
			flag = true;
			break;
		...
		case AnimationType.FromBy:
			thickness = _keyValues[0];
			thickness2 = AnimatedTypeHelpers.AddThickness(_keyValues[0], _keyValues[1]);
			if (IsAdditive)
			{
				value2 = defaultOriginValue;
				flag = true;
	...
	{
		ThicknessAnimation obj = (ThicknessAnimation)d;
	...
	private static bool ValidateFromToOrByValue(object value)
	{
		...
		{
			return AnimatedTypeHelpers.IsValidAnimationValueThickness(thickness.Value);
		}
		return true;
	}
}
