...
{
	private static readonly object _valueSerializersLock;
	...
	public static ValueSerializer GetSerializerFor(Type type)
	{
		...
		ValueSerializerAttribute valueSerializerAttribute = TypeDescriptor.GetAttributes(type)[typeof(ValueSerializerAttribute)] as ValueSerializerAttribute;
	...
	protected Exception GetConvertToException(object value, Type destinationType)
	{
		...
		return new NotSupportedException(System.SR.Format(p2: (value != null) ? value.GetType().FullName : System.SR.ToStringNull, resourceFormat: System.SR.ConvertToException, p1: GetType().Name, p3: destinationType.FullName));
	}
	...
	{
		return new NotSupportedException(System.SR.Format(p2: (value != null) ? value.GetType().FullName : System.SR.ToStringNull, resourceFormat: System.SR.ConvertFromException, p1: GetType().Name));
	}
