...
internal abstract class XmlBaseConverter : XmlValueConverter
{
	...
	internal static int DecimalToInt32(decimal value)
	{
		...
		{
			throw new OverflowException(Res.GetString("Value '{0}' was either too large or too small for {1}.", XmlConvert.ToString(value), "Int32"));
		}
		return (int)value;
	}
	...
	protected static long DecimalToInt64(decimal value)
	{
		...
		{
			throw new OverflowException(Res.GetString("Value '{0}' was either too large or too small for {1}.", XmlConvert.ToString(value), "Int64"));
		}
		return (long)value;
	}
	...
	protected static ulong DecimalToUInt64(decimal value)
	{
		...
		{
			throw new OverflowException(Res.GetString("Value '{0}' was either too large or too small for {1}.", XmlConvert.ToString(value), "UInt64"));
		}
		return (ulong)value;
	}
	...
	protected static byte Int32ToByte(int value)
	{
		...
		{
			throw new OverflowException(Res.GetString("Value '{0}' was either too large or too small for {1}.", XmlConvert.ToString(value), "Byte"));
		}
		return (byte)value;
	}
	...
	protected static short Int32ToInt16(int value)
	{
		...
		{
			throw new OverflowException(Res.GetString("Value '{0}' was either too large or too small for {1}.", XmlConvert.ToString(value), "Int16"));
		}
		return (short)value;
	}
	...
	protected static sbyte Int32ToSByte(int value)
	{
		...
		{
			throw new OverflowException(Res.GetString("Value '{0}' was either too large or too small for {1}.", XmlConvert.ToString(value), "SByte"));
		}
		return (sbyte)value;
	}
	...
	protected static ushort Int32ToUInt16(int value)
	{
		...
		{
			throw new OverflowException(Res.GetString("Value '{0}' was either too large or too small for {1}.", XmlConvert.ToString(value), "UInt16"));
		}
		return (ushort)value;
	}
	...
	protected static uint Int64ToUInt32(long value)
	{
		...
		{
			throw new OverflowException(Res.GetString("Value '{0}' was either too large or too small for {1}.", XmlConvert.ToString(value), "UInt32"));
		}
		return (uint)value;
	}
