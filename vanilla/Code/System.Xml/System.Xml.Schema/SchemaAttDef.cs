...
internal sealed class SchemaAttDef : SchemaDeclBase, IDtdDefaultAttributeInfo, IDtdAttributeInfo
{
	...
	string IDtdAttributeInfo.Prefix => base.Prefix;

	string IDtdAttributeInfo.LocalName => base.Name.Name;
	...
	bool IDtdAttributeInfo.IsDeclaredInExternal => base.IsDeclaredInExternal;
	...
	object IDtdDefaultAttributeInfo.DefaultValueTyped => base.DefaultValueTyped;
