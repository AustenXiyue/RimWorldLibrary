...
{
	private System.Collections.Generic.LargeArrayBuilder<T> _builder;
	...
	public SparseArrayBuilder(bool initialize)
	{
		...
		_builder = new System.Collections.Generic.LargeArrayBuilder<T>(initialize: true);
	}
	...
	{
		int num = 0;
		System.Collections.Generic.CopyPosition position = System.Collections.Generic.CopyPosition.Start;
	...
	{
		if (System.Collections.Generic.EnumerableHelpers.TryGetCount(items, out var count))
		{
			if (count > 0)
			{
				Reserve(count);
