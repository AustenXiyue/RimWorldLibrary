...
internal sealed class BeginEndAwaitableAdapter : ICriticalNotifyCompletion, INotifyCompletion
{
	...
	{
		BeginEndAwaitableAdapter obj = (BeginEndAwaitableAdapter)asyncResult.AsyncState;
		obj._asyncResult = asyncResult;
		Interlocked.Exchange(ref obj._continuation, CALLBACK_RAN)?.Invoke();
	};
