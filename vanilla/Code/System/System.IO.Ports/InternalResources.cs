...
internal static class InternalResources
{
	...
	internal static void WinIOError(int errorCode, string str)
	{
		...
		case 5:
			...
			throw new UnauthorizedAccessException(global::SR.GetString("Access to the port '{0}' is denied.", str));
		case 206:
		...
		case 32:
			...
			throw new IOException(global::SR.GetString("The process cannot access the port '{0}' because it is being used by another process.", str));
		default:
