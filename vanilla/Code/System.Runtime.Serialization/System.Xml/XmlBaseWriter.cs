		...
		public void AddNamespace(string prefix, string uri, XmlDictionaryString uriDictionaryString)
		{
			...
			for (int num = nsCount - 1; num >= 0; num--)
			{
				...
				if (@namespace.Prefix == prefix)
				{
					...
					throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(SR.GetString("The prefix '{0}' is bound to the namespace '{1}' and cannot be changed to '{2}'.", prefix, @namespace.Uri, uri), "prefix"));
				}
			}
