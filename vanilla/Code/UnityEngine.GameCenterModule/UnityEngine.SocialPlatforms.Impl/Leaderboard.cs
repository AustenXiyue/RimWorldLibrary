...
public class Leaderboard : ILeaderboard
{
	...
	{
		return string.Concat("ID: '", id, "' Title: '", m_Title, "' Loading: '", m_Loading.ToString(), "' Range: [", range.from, ",", range.count, "] MaxRange: '", m_MaxRange, "' Scores: '", m_Scores.Length, "' UserScope: '", userScope, "' TimeScope: '", timeScope, "' UserFilter: '", m_UserIDs.Length);
	}
