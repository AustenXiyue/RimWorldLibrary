...
internal sealed class ObjectReader
{
	...
	{
		throw new SerializationException(Environment.GetResourceString("Parse error. Current element is not compatible with the next element, {0}.", string.Concat(onStack.PRname, " ", onStack.PRparseTypeEnum, " ", processing.PRname, " ", processing.PRparseTypeEnum)));
	}
