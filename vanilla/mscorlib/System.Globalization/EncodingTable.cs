...
internal static class EncodingTable
{
	...
	{
		InternalEncodingDataItem result = default(InternalEncodingDataItem);
		result.webName = name;
		result.codePage = cp;
		return result;
	}
	...
	{
		InternalCodePageDataItem result = default(InternalCodePageDataItem);
		result.codePage = cp;
		result.uiFamilyCodePage = fcp;
		result.flags = flags;
		result.Names = names;
		return result;
	}
	...
	static EncodingTable()
	{
		...
		codePageDataPtr = new InternalCodePageDataItem[96]
		{
