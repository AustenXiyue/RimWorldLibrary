...
internal sealed class QueryBuilder
{
	...
	private Query ProcessFunction(Function root, out Props props)
	{
		...
		{
			Query result = new IDQuery(ProcessNode(root.ArgumentList[0], Flags.None, out props));
			props |= Props.NonFlat;
			return result;
		}
		...
		case Function.FunctionType.FuncUserDefined:
		{
			...
			Query result = new FunctionQuery(root.Prefix, root.Name, ProcessArguments(root.ArgumentList, out props));
			props |= Props.NonFlat;
			return result;
		}
		default:
