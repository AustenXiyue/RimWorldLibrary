...
internal static class XPathConvert
{
	private struct BigNumber
	{
		...
		private void Mul(ref BigNumber numOp)
		{
			...
			if ((u5 & 0x80000000u) == 0)
			{
				if ((u2 & 0x40000000) != 0 && ((u2 & 0xBFFFFFFFu) != 0 || u != 0 || num != 0) && AddU(ref u2, 1073741824u) != 0 && AddU(ref u3, 1u) != 0 && AddU(ref u4, 1u) != 0)
				{
					AddU(ref u5, 1u);
					if ((u5 & 0x80000000u) != 0)
					{
				...
				_exp--;
				_error <<= 1;
				if ((u2 & 0x7FFFFFFF) != 0 || u != 0 || num != 0)
				{
					_error++;
				}
				return;
			}
			if ((u2 & 0x80000000u) != 0 && ((u3 & 1) != 0 || (u2 & 0x7FFFFFFF) != 0 || u != 0 || num != 0) && AddU(ref u3, 1u) != 0 && AddU(ref u4, 1u) != 0 && AddU(ref u5, 1u) != 0)
			{
				u5 = 2147483648u;
				_exp++;
			}
		...
		public static explicit operator double(BigNumber bn)
		{
			...
			if ((num2 & 0x80000000u) != 0 && ((num2 & 0x7FFFFFFF) != 0 || (u2 & 1) != 0) && AddU(ref u2, 1u) != 0)
			{
				AddU(ref u, 1u);
			}
