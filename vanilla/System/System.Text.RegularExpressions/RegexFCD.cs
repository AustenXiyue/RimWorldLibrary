...
internal sealed class RegexFCD
{
	...
	internal static RegexPrefix Prefix(RegexTree tree)
	{
		...
		while (true)
		{
			...
			case 6:
				if (regexNode2._m > 0)
				{
					return new RegexPrefix(string.Empty.PadRight(regexNode2._m, regexNode2._ch), (regexNode2._options & RegexOptions.IgnoreCase) != 0);
				}
	...
	private void CalculateFC(int NodeType, RegexNode node, int CurIndex)
	{
		...
		case 42:
			...
			break;
		default:
			throw new ArgumentException(global::SR.GetString("Unexpected opcode in regular expression generation: {0}.", NodeType.ToString(CultureInfo.CurrentCulture)));
		case 88:
		case 89:
		case 90:
		case 91:
