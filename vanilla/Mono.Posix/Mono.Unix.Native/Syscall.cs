...
public sealed class Syscall : Stdlib
{
	...
	{
		fixed (SockaddrType* type = &Sockaddr.GetAddress(address).type)
		{
			fixed (byte* dynamicData = Sockaddr.GetDynamicData(address))
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(address, dynamicData, useMaxLength: false);
				return sys_bind(socket, Sockaddr.GetNative(&sockaddrDynamic, type));
			}
		}
	}
	...
	public unsafe static int connect(int socket, Sockaddr address)
	{
		fixed (SockaddrType* type = &Sockaddr.GetAddress(address).type)
		{
			...
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(address, dynamicData, useMaxLength: false);
				return sys_connect(socket, Sockaddr.GetNative(&sockaddrDynamic, type));
			}
		}
	}
	...
	public unsafe static int accept(int socket, Sockaddr address)
	{
		fixed (SockaddrType* type = &Sockaddr.GetAddress(address).type)
		{
			fixed (byte* dynamicData = Sockaddr.GetDynamicData(address))
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(address, dynamicData, useMaxLength: true);
				int result = sys_accept(socket, Sockaddr.GetNative(&sockaddrDynamic, type));
	...
	public unsafe static int accept4(int socket, Sockaddr address, UnixSocketFlags flags)
	{
		...
		fixed (SockaddrType* type = &Sockaddr.GetAddress(address).type)
		{
			...
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(address, dynamicData, useMaxLength: true);
				int result = sys_accept4(socket, Sockaddr.GetNative(&sockaddrDynamic, type), flags2);
				sockaddrDynamic.Update(address);
				return result;
			}
		}
	...
	public unsafe static int getpeername(int socket, Sockaddr address)
	{
		fixed (SockaddrType* type = &Sockaddr.GetAddress(address).type)
		{
			...
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(address, dynamicData, useMaxLength: true);
				int result = sys_getpeername(socket, Sockaddr.GetNative(&sockaddrDynamic, type));
				sockaddrDynamic.Update(address);
				return result;
			}
		}
	...
	public unsafe static int getsockname(int socket, Sockaddr address)
	{
		fixed (SockaddrType* type = &Sockaddr.GetAddress(address).type)
		{
			...
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(address, dynamicData, useMaxLength: true);
				int result = sys_getsockname(socket, Sockaddr.GetNative(&sockaddrDynamic, type));
				sockaddrDynamic.Update(address);
				return result;
			}
		}
	...
	public unsafe static long recvfrom(int socket, void* buffer, ulong length, MessageFlags flags, Sockaddr address)
	{
		...
		fixed (SockaddrType* type = &Sockaddr.GetAddress(address).type)
		{
			...
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(address, dynamicData, useMaxLength: true);
				long result = sys_recvfrom(socket, buffer, length, flags2, Sockaddr.GetNative(&sockaddrDynamic, type));
				sockaddrDynamic.Update(address);
				return result;
			}
		}
	...
	public unsafe static long sendto(int socket, void* message, ulong length, MessageFlags flags, Sockaddr address)
	{
		...
		fixed (SockaddrType* type = &Sockaddr.GetAddress(address).type)
		{
			...
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(address, dynamicData, useMaxLength: false);
				return sys_sendto(socket, message, length, flags2, Sockaddr.GetNative(&sockaddrDynamic, type));
			}
		}
	}
	...
	public unsafe static long recvmsg(int socket, Msghdr message, MessageFlags flags)
	{
		...
		fixed (byte* msg_control = message.msg_control)
		{
			fixed (Iovec* msg_iov = message.msg_iov)
			{
				_Msghdr message2 = new _Msghdr(message, msg_iov, msg_control);
				long result;
				fixed (SockaddrType* type = &Sockaddr.GetAddress(msg_name).type)
				{
					fixed (byte* dynamicData = Sockaddr.GetDynamicData(msg_name))
					{
						_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(msg_name, dynamicData, useMaxLength: true);
						result = sys_recvmsg(socket, ref message2, Sockaddr.GetNative(&sockaddrDynamic, type), flags2);
		...
		fixed (byte* msg_control = message.msg_control)
		{
			fixed (Iovec* msg_iov = message.msg_iov)
			{
				...
				fixed (SockaddrType* type = &Sockaddr.GetAddress(msg_name).type)
				{
					fixed (byte* dynamicData = Sockaddr.GetDynamicData(msg_name))
					{
						_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(msg_name, dynamicData, useMaxLength: false);
						return sys_sendmsg(socket, ref message2, Sockaddr.GetNative(&sockaddrDynamic, type), flags2);
					}
				}
			}
		}
