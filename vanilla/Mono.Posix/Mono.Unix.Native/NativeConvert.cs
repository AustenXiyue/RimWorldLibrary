...
public sealed class NativeConvert
{
	...
	public unsafe static bool TryCopy(Sockaddr source, IntPtr destination)
	{
		...
		fixed (SockaddrType* type = &Sockaddr.GetAddress(source).type)
		{
			fixed (byte* data = dynamicData)
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(source, data, useMaxLength: false);
				return FromSockaddr(Sockaddr.GetNative(&sockaddrDynamic, type), destination) == 0;
			}
		}
	}
	...
	public unsafe static bool TryCopy(IntPtr source, long size, Sockaddr destination)
	{
		...
		fixed (SockaddrType* type = &Sockaddr.GetAddress(destination).type)
		{
			fixed (byte* dynamicData2 = Sockaddr.GetDynamicData(destination))
			{
				_SockaddrDynamic sockaddrDynamic = new _SockaddrDynamic(destination, dynamicData2, useMaxLength: true);
				int num = ToSockaddr(source, size, Sockaddr.GetNative(&sockaddrDynamic, type));
	...
	{
		if (FromAtFlags(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToAtFlags(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromEpollEvents(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToEpollEvents(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromEpollFlags(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToEpollFlags(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromMessageFlags(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToMessageFlags(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromShutdownOption(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToShutdownOption(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromSockaddrType(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToSockaddrType(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromUnixAddressFamily(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToUnixAddressFamily(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromUnixSocketControlMessage(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToUnixSocketControlMessage(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromUnixSocketFlags(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToUnixSocketFlags(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromUnixSocketOptionName(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToUnixSocketOptionName(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromUnixSocketProtocol(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToUnixSocketProtocol(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (FromUnixSocketType(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
	...
	{
		if (ToUnixSocketType(value, out var rval) == -1)
		{
			ThrowArgumentException(value);
		}
		return rval;
