	...
	public unsafe override int GetBytes(char* chars, int charCount, byte* bytes, int byteCount)
	{
		...
		while (charCount > 0)
		{
			...
			if (num3 < 2048)
			{
				...
				bytes[num++] = (byte)(0xC0 | (num3 >> 6));
				bytes[num++] = (byte)(0x80 | (num3 & 0x3F));
				continue;
			}
			if (num3 < 65536)
			{
				...
				bytes[num++] = (byte)(0xE0 | (num3 >> 12));
				bytes[num++] = (byte)(0x80 | ((num3 >> 6) & 0x3F));
				bytes[num++] = (byte)(0x80 | (num3 & 0x3F));
				continue;
			}
			if (num + 4 > byteCount)
			...
			bytes[num++] = (byte)(0xF0 | (num3 >> 18));
			bytes[num++] = (byte)(0x80 | ((num3 >> 12) & 0x3F));
			bytes[num++] = (byte)(0x80 | ((num3 >> 6) & 0x3F));
			bytes[num++] = (byte)(0x80 | (num3 & 0x3F));
		}
		return num;
