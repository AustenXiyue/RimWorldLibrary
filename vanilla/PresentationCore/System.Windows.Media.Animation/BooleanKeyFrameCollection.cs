...
public class BooleanKeyFrameCollection : Freezable, IList, ICollection, IEnumerable
{
	...
	public static BooleanKeyFrameCollection Empty
	{
		get
		{
			if (s_emptyCollection == null)
			{
				...
				s_emptyCollection = booleanKeyFrameCollection;
			}
	...
	/// <param name="index">The object to remove from the <see cref="T:System.Collections.IList" />.</param>
	...
	protected override void CloneCore(Freezable sourceFreezable)
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			_keyFrames.Add(booleanKeyFrame);
			OnFreezablePropertyChanged(null, booleanKeyFrame);
		}
	}
	...
	/// <returns>Remarks true if the <see cref="T:System.Object" /> is found in the <see cref="T:System.Collections.IList" />; otherwise, false.</returns>
