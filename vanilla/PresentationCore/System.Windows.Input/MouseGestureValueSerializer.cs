...
public class MouseGestureValueSerializer : ValueSerializer
{
	...
	{
		bool result = false;
		if (value is MouseGesture mouseGesture && ModifierKeysConverter.IsDefinedModifierKeys(mouseGesture.Modifiers) && MouseActionConverter.IsDefinedMouseAction(mouseGesture.MouseAction))
		{
			result = true;
		}
		return result;
