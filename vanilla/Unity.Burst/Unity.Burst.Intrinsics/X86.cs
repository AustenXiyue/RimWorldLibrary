...
public static class X86
{
	public static class Avx
	{
		...
		public static v128 cmp_pd(v128 a, v128 b, int imm8)
		{
			return (CMP)imm8 switch
			{
				...
				CMP.TRUE_US => new v128(-1), 
				_ => throw new InvalidOperationException($"invalid imm8 value {imm8} for comparison"), 
			};
		}
	...
	public static class Sse4_1
	{
		...
		public static v128 dp_pd(v128 a, v128 b, int imm8)
		{
			...
			v128 result = default(v128);
			result.Double0 = (((imm8 & 1) != 0) ? num3 : 0.0);
			result.Double1 = (((imm8 & 2) != 0) ? num3 : 0.0);
			return result;
		}
		...
		public static v128 dp_ps(v128 a, v128 b, int imm8)
		{
			...
			v128 result = default(v128);
			result.Float0 = (((imm8 & 1) != 0) ? num5 : 0f);
			result.Float1 = (((imm8 & 2) != 0) ? num5 : 0f);
			result.Float2 = (((imm8 & 4) != 0) ? num5 : 0f);
			result.Float3 = (((imm8 & 8) != 0) ? num5 : 0f);
			return result;
		}
	...
	public static class Ssse3
	{
		...
		public unsafe static v128 alignr_epi8(v128 a, v128 b, int count)
		{
			if (count < 0 || count > 16)
			{
				throw new ArgumentException("align count out of range", "count");
			}
			v128 result = default(v128);
			byte* ptr = &result.Byte0;
	...
	private unsafe static void CheckPointerAlignment16(void* mem_addr)
	{
		if (((long)(IntPtr)mem_addr & 0xF) != 0L)
		{
