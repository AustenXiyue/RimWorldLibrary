...
public sealed class ParticleSystem : Component
{
	...
	{
		Trails trails = default(Trails);
		trails.positions = new List<Vector4>();
		trails.frontPositions = new List<int>();
		trails.backPositions = new List<int>();
		trails.positionCounts = new List<int>();
