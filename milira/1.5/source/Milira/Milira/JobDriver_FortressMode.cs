...
public class JobDriver_FortressMode : JobDriver
{
	...
	private void DeployPod()
	{
		...
		CompThingCarrier comp = pawn.TryGetComp<CompThingCarrier>();
		...
		{
			SetHitPointAndRemoveResourceInCarrier(comp, 200, 60);
		}
		else
		{
			SetHitPointAndRemoveResourceInCarrier(comp, 1200, 600);
		}
	...
	private void SetHitPointAndRemoveResourceInCarrier(CompThingCarrier comp, int hitPoint, int initiationDelayTicks)
	{
