...
public class CompAbilityEffect_Excalibur : CompAbilityEffect
{
	...
	public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
	{
		...
		{
			GenExplosion.DoExplosion(item, map, 0.9f, MiliraDefOf.Milira_PlasmaBomb_TwoHandSword, Pawn, 3 * (int)damageAmount, 2f * armorPenetration, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null, doVisualEffects: true, 1f, 0f, doSoundEffects: true, null, 4f);
		}
	...
	public override IEnumerable<PreCastAction> GetPreCastActions()
	{
		yield return new PreCastAction
		{
			action = delegate
			{
				parent.AddEffecterToMaintain(MiliraDefOf.Milira_TwoHandSwordWarmup.Spawn(Pawn.Position, Pawn.Map), Pawn.Position, 480, Pawn.Map);
			},
