	...
	private void ChargeDamage()
	{
		...
		for (int i = 0; i < list.Count; i++)
		{
			...
			if (list[i] is Pawn)
			{
				...
				{
					AncotUtility.DoDamage(pawn, damageDef, damageAmountExact, armorPenetration, base.FlyingPawn);
					break;
				}
			}
			if (list[i] is Building)
			{
				...
				{
					AncotUtility.DoDamage(building, damageDef, damageAmountExact / 5f, armorPenetration, base.FlyingPawn);
				}
			}
		}
	}
