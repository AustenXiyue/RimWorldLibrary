...
public class Projectile_ExplosiveWithEMP : Projectile_Explosive
{
	...
	protected override void Impact(Thing hitThing, bool blockedByShield = false)
	{
		...
		GenExplosion.DoExplosion(position, map2, explosionRadius, damageDef, instigator, damageAmount, armorPenetration, soundExplode, weapon, projectile, intendedTarget.Thing, postExplosionSpawnThingDef, 0f, 0, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
		for (int i = 0; i < 1; i++)
		{
	...
	{
		GenExplosion.DoExplosion(pos, map, radius, DamageDefOf.EMP, launcher, DamageAmount, ArmorPenetration, null, equipmentDef, def, intendedTarget.Thing, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, null, null);
	}
}
