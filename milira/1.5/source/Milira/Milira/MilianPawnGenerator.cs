...
public class MilianPawnGenerator
{
	public static PawnKindDef PawnKindGenerator()
	{
		...
		milira_FallenAngel.race = MiliraDefOf.Milira_Race;
		milira_FallenAngel.defaultFactionType = MiliraDefOf.Milira_Faction;
		...
		milira_FallenAngel.maxGenerationAge = 0;
		milira_FallenAngel.minGenerationAge = 1000;
