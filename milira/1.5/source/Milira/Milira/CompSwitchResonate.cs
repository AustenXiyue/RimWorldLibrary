...
public class CompSwitchResonate : ThingComp
{
	...
	public IEnumerable<Gizmo> GetGizmos()
	{
		...
		command_Action.action = delegate
		{
			...
			{
				CompSwitchResonate compSwitchResonate2 = parent.TryGetComp<CompSwitchResonate>();
				if (compSwitchResonate2 != null)
				{
					resonateNum = 2f;
					compSwitchResonate2.resonateClass = MiliraDefOf.Milian_ClassHediff_Knight;
					compSwitchResonate2.SetClassHediffToInitial(PawnOwner.Map, PawnOwner);
				}
			...
			{
				CompSwitchResonate compSwitchResonate3 = parent.TryGetComp<CompSwitchResonate>();
				if (compSwitchResonate3 != null)
				{
					resonateNum = 3f;
					compSwitchResonate3.resonateClass = MiliraDefOf.Milian_ClassHediff_Bishop;
					compSwitchResonate3.SetClassHediffToInitial(PawnOwner.Map, PawnOwner);
				}
			...
			{
				CompSwitchResonate compSwitchResonate4 = parent.TryGetComp<CompSwitchResonate>();
				if (compSwitchResonate4 != null)
				{
					resonateNum = 4f;
					compSwitchResonate4.resonateClass = MiliraDefOf.Milian_ClassHediff_Rook;
					compSwitchResonate4.SetClassHediffToInitial(PawnOwner.Map, PawnOwner);
				}
