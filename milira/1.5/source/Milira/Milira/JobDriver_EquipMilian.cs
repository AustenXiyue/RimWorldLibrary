...
public class JobDriver_EquipMilian : JobDriver
{
	...
	private void EquipMilian()
	{
		...
		if (thingWithComps != null)
		{
			...
			{
				HediffComp_AlternateWeapon hediffComp_AlternateWeapon = Milian.health.hediffSet.GetFirstHediffOfDef(MiliraDefOf.MilianFitting_TacticalSling).TryGetComp<HediffComp_AlternateWeapon>();
				if (hediffComp_AlternateWeapon.ContainedThing == null)
				{
					hediffComp_AlternateWeapon.AddToContainer(resultingEq);
				}
			}
		}
