...
public class CompSunBlastFurnaceOutdoorBreakdown : ThingComp
{
	...
	public void DoBreakdown()
	{
		...
		GenExplosion.DoExplosion(parent.Position, parent.Map, radius, DamageDefOf.Bomb, null, damAmount, fuel, null, null, null, null, ThingDefOf.Filth_Fuel, 0.6f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 0, 1f, damageFalloff: false, null, null, null);
