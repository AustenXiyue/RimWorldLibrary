...
public class QuestNode_Root_FallenAngel : QuestNode_Root_WandererJoin
{
	...
	protected override void AddSpawnPawnQuestParts(Quest quest, Map map, Pawn pawn)
	{
		...
		Faction faction = Find.FactionManager.FirstFactionOfDef(MiliraDefOf.Milira_Faction);
		quest.DropPods(map.Parent, contents, null, null, null, null, false, useTradeDropSpot: false, joinPlayer: false, makePrisoners: false, null, null, QuestPart.SignalListenMode.OngoingOnly, null, destroyItemsOnCleanup: true, dropAllInSamePod: true, allowFogged: false, faction);
	}
