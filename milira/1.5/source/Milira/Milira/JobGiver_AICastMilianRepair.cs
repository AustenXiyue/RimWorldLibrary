...
public class JobGiver_AICastMilianRepair : JobGiver_AICastAbility
{
	...
	protected override LocalTargetInfo GetTarget(Pawn caster, Ability ability)
	{
		...
		{
			if (caster.CanReserve(item2, 1, -1, null, ignoreOtherReservations: true) && item2.Faction == caster.Faction && item2.HitPoints < item2.MaxHitPoints && item2.def.building.combatPower > 0f)
			{
