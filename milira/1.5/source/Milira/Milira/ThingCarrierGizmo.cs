...
{
	public CompThingCarrier carrier;
	...
	public ThingCarrierGizmo(CompThingCarrier carrier)
	{
	...
	private string GetResourceBarTip()
	{
		...
		stringBuilder.AppendInNewLine("Milira_FortressCarrierDesc".Translate(carrier.parent.def.label));
